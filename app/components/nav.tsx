...
function NavBar() {
  return (
    <nav className="text-white border-gray-200 dark:bg-gray-900">
      <div className="bg-[#008080] max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <Link
          href="/"
        ...
        >
          ...
          <ul className="flex flex-col text-white p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-[#008080] dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <Link
                href="#"
